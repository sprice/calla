 ...
 */
function dev_installer_profile_details() {
  return array(
 ...
 */
function dev_installer_profile_modules() {
  $modules = array(
     // Drupal core
    'block',
    'comment',
 ...
 */
function _dev_installer_dev_modules() {
  return array(
    // Strongarm
    'strongarm',
    // CCK
 ...
 */
function dev_installer_profile_task_list() {
  /*
 ...
 */
function dev_installer_profile_tasks(&$task, $url) {
  ...
  */
  ...
  if ($task == 'dev-modules') {
    $modules = _dev_installer_dev_modules();
    $files = module_rebuild_cache();
    // Create batch
    foreach ($modules as $module) {
      $batch['operations'][] = array('_install_module_batch', array($module, $files[$module]->info['name']));
    }    
    $batch['finished'] = '_dev_installer_profile_batch_finished';
  ...
  if ($task == 'intranet-configure') {
    ...
    $batch['operations'][] = array('_dev_installer_intranet_configure', array());
    $batch['operations'][] = array('_dev_installer_intranet_configure_check', array());
    $batch['finished'] = '_dev_installer_intranet_configure_finished';
 ...
 */
function _dev_installer_intranet_configure() {
  global $install_locale;
 ...
 */
function _dev_installer_intranet_configure_check() {
 ...
 */
function _dev_installer_intranet_configure_finished($success, $results) {
 ...
 */
function _dev_installer_profile_batch_finished($success, $results) {
 ...
 */
/*
function _dev_installer_translate_batch_finished($success, $results) {
...
function system_form_install_select_profile_form_alter(&$form, $form_state) {
  foreach($form['profile'] as $key => $element) {
    $form['profile'][$key]['#value'] = 'dev_installer';
  }
}
